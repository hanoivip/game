...
->group(function () {
    ...
    Route::post('/newrecharge/stat/today', 'Admin@today')->name('ecmin.newrecharge.statsToday');
    Route::post('/newrecharge/stat/month', 'Admin@thisMonth')->name('ecmin.newrecharge.statsMonth');
